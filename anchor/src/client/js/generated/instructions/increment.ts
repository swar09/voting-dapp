...
export type IncrementInput<TAccountVotingdapp extends string = string> = {
...
>(
  input: IncrementInput<TAccountVotingdapp>,
  config?: { programAddress?: TProgramAddress }
): IncrementInstruction<TProgramAddress, TAccountVotingdapp> {
  // Program address.
  ...
  return Object.freeze({
    ...
    programAddress,
  } as IncrementInstruction<TProgramAddress, TAccountVotingdapp>);
}
...
>(
  ...
  return {
    ...
    accounts: { votingdapp: getNextAccount() },
